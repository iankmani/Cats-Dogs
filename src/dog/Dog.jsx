    ...
    <section className="dog-page">
      ...
      <div className="dog-card-container">
        <div className="dog-card">
          ...
          <h2>Borboel</h2>
          <a href="https://www.akc.org/dog-breeds/boerboel/" target="_blank">
            Learn more
          </a>
        </div>
        <div className="dog-card">
          ...
          <a
            href="https://www.thesprucepets.com/siberian-husky-dog-breed-profile-1118000"
            target="_blank"
          >
            Learn more
          </a>
        ...
        <div className="dog-card">
          ...
          <h2>Pitbull</h2>
          <a href="https://www.britannica.com/animal/pit-bull" target="_blank">
            Learn more
          </a>
        </div>
        <div className="dog-card">
          ...
          <h2>Rotweiller</h2>
          <a
            href="https://www.thesprucepets.com/breed-profile-rottweiler-1117993"
            target="_blank"
          >
            Learn more
          </a>
        ...
        <div className="dog-card">
          ...
          <a
            href="https://www.akc.org/expert-advice/lifestyle/facts-about-the-doberman-pinscher/"
            target="_blank"
          >
            Learn more
          </a>
        ...
        <div className="dog-card">
          ...
          <a
            href="https://www.thesprucepets.com/breed-profile-german-shepherd-dog-1117967"
            target="_blank"
          >
            Learn more
          </a>
